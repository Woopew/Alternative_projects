 ...
 *	
 *	Default Settings:
 *	LCD D4-D7 data pins are connected to PORTB pins RB0-RB2 and RC3
...
#define LCD_D4 LATBbits.LATB0			//LCD Databit D4
#define LCD_D5 LATBbits.LATB1			//LCD Databit D5
#define LCD_D6 LATBbits.LATB2			//LCD Databit D6
#define LCD_D7 LATCbits.LATC3			//LCD Databit D7

#define LCD_EN LATBbits.LATB4			//LCD Enable
#define	LCD_RS LATBbits.LATB5			//LCD Register Select
